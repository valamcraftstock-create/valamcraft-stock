...
import { TrendingUp, TrendingDown, IndianRupee, Calendar, X, Eye, ArrowUpRight, ArrowDownLeft, User, Package, Clock, Download } from 'lucide-react';

export default function Transactions() {
  const { transactions } = useStockFlow();
  ...
  const handleDownloadPDF = () => {
    ...
    autoTable(doc, {
        startY: 75,
        head: [['Date', 'ID', 'Type', 'Customer', 'Amount']],
        body: tableBody,
        theme: 'striped',
